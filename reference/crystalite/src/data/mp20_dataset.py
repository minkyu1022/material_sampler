...
class MP20(InMemoryDataset):
    ...
    def process(self) -> None:
        raw_cache = os.path.join(self.root, "raw", "all_mp20.pt")
        if os.path.exists(raw_cache):
            # raw cache stores pickled python objects, not just tensors.
        ...
        for data_dict in cached_data:
            ...
            data = Data(
                ...
                lattices_scaled=torch.Tensor(graph_arrays["lattices_scaled"]).unsqueeze(
                    0
                ),
