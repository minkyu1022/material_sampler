...
# GLOBAL SETTINGS
# =================================================================
# 1. Use Env Vars if provided by Kubeflow, otherwise default to your PVC paths
GPUS=8
PROJECT_ROOT="/home/jovyan/AlphaMOF"
CHECKPOINT_ROOT="/home/jovyan/ny-ckpts"

# 2. Python Setup
PYTHON_SCRIPT="src/train.py"
BASE_DATA_CONF="data=odac25"
LOGGER="logger=wandb"
...
STAGE_1_EPOCHS=500
STAGE_1_PRETRAINED_CKPT="" # LEAVE EMPTY IF NOT RESUMING
...
run_stage() {
    ...
    if [ ! -z "$manual_ckpt" ]; then
        ...
        CMD="${CMD} pretrained_ckpt_path=${manual_ckpt}"
...
# run_stage 1 "$STAGE_1_NAME" "$STAGE_1_ATOMS" "$STAGE_1_SQUARE" "$STAGE_1_EPOCHS" "" "$STAGE_1_PRETRAINED_CKPT"
