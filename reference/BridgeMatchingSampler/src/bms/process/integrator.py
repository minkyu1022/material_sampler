...
"""Numerical integrators used to simulate the (controlled) SDE."""
...
from bms.process.sde import BaseSDE
...
class BaseIntegrator(nn.Module, ABC):
    ...
    def run(
        self,
        initial_data: torch.Tensor,  # [B, N, 3]
