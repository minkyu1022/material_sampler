...
from pairmixer.model.modules.confidence_utils import (
...
from pairmixer.model.modules.pairmixer import PairmixerWithSeqAttnModule
from pairmixer.model.modules.utils import LinearNoBias
...
class ConfidenceModule(nn.Module):
    ...
    def __init__(
        ...
        if self.imitate_trunk:
            ...
            assert not pairmixer, "Pairmixer is not supported with imitate_trunk"
        else:
            ...
            if pairmixer:
                self.pairformer_stack = PairmixerWithSeqAttnModule(token_s, token_z, **pairformer_args)
            else:
