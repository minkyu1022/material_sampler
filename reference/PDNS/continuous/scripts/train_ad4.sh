...
srun pwd && SLURM_GPUS_PER_NODE=1 CUDA_VISIBLE_DEVICES=0 python train.py experiment=ad_ic \
    save_freq=1000 epsilon=0.1 ema_decay=0.999 optim.beta1=0.0 optim.beta2=0.999 \
    num_epochs_per_stage=1000 num_epochs=1000000 optim.lr=1e-5 resample_batch_size=10000 \
